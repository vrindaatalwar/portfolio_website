...
// Tech Icons (Simple representations or text for clarity)
export const JavaIcon = ({ className }: { className?: string }) => (
  <div className={`flex items-center justify-center font-bold text-xs ${className}`}>Java</div>
);
export const PythonIcon = ({ className }: { className?: string }) => (
  <div className={`flex items-center justify-center font-bold text-xs ${className}`}>Py</div>
);
export const SqlIcon = ({ className }: { className?: string }) => (
  <div className={`flex items-center justify-center font-bold text-xs ${className}`}>SQL</div>
);
...
export const NextIcon = ({ className }: { className?: string }) => (
  <div className={`flex items-center justify-center font-bold text-[10px] ${className}`}>N</div>
);
export const ExpressIcon = ({ className }: { className?: string }) => (
  <div className={`flex items-center justify-center font-bold text-[10px] ${className}`}>ex</div>
);