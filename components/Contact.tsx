        ...
        <div className="w-full border border-border rounded-xl p-6 flex flex-col gap-8 bg-surface/20">
            ...
            <form className="flex gap-4">
                <input 
                    ...
                    className="flex-1 bg-surface border border-border rounded-md px-4 py-2 text-sm text-text-primary placeholder-text-muted focus:outline-none focus:border-text-secondary transition-colors"
                />
                <button 
                    type="submit"
                    className="bg-secondary hover:bg-surface text-text-primary text-xs px-4 py-2 rounded-md border border-border transition-colors whitespace-nowrap"
                >
                    Send Enquiry
                </button>
            </form>
